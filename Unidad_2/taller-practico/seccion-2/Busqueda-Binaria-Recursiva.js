...
if (objetivo < arr[medio]) {
    return busquedaBinariaRecursiva(arr, objetivo, bajo, medio - 1); // buscara a la izquierda
  } else {
    return busquedaBinariaRecursiva(arr, objetivo, medio + 1, alto); // buscara a  la derecha
  }
